...
class Website extends WebsiteErrors
{
    ...
    public static function loadWebsiteConfig()
    {
        ...
        self::$websiteConfig->setConfig(Config::get('otserver.site'));
    }
    ...
    public static function loadServerConfig()
    {
        ...
        self::$serverConfig->setConfig(Config::get('otserver.server'));
    }
    ...
    public static function getCountryCode($IP)
    {
        ...
        if (!file_exists('cache/flags/flag' . $a[0])) {
            ...
            if ($flagData === false)
                return 'unknown';
            if (@file_put_contents('assets/cache/flags/flag' . $a[0], $flagData) === false)
                return 'unknown';
        }
        $countries = unserialize(file_get_contents('assets/cache/flags/flag' . $a[0])); // load file
