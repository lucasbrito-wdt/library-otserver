...
class Database_MySQL extends Database
{
    ...
    {
        try {
            parent::__construct('mysql:host=' . $this->getDatabaseHost() . ';port=' . $this->getDatabasePort() . ';dbname=' . $this->getDatabaseName() . ';charset=utf8', $this->getDatabaseUsername(), $this->getDatabasePassword());
